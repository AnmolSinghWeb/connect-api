...
class MUsers(NtApiModel):
    ...
    def client(self):
        return chromadb.HttpClient(host='ec2-54-226-38-15.compute-1.amazonaws.com', port=8000, settings=Settings(allow_reset=True, anonymized_telemetry=False))
